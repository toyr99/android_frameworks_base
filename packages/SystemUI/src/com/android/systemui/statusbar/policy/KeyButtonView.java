...
public class KeyButtonView extends ImageView {
        ...
        public void run() {
            ...
            if (isPressed()) {
                ...
                if (mLongpressAction != null
                    && MahdiActions.isActionKeyEvent(mLongpressAction)) {
                ...
                if (!mIsLongpressed) {
                    if (isPressed()) {
                        if (mClickAction != null
                            && !MahdiActions.isActionKeyEvent(mClickAction)) {
    ...
    private OnClickListener mClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            MahdiActions.processAction(mContext, mClickAction, false);
            return;
        }
    };
    ...
    private OnLongClickListener mLongPressListener = new OnLongClickListener() {
        ...
        public boolean onLongClick(View v) {
            ...
            MahdiActions.processAction(mContext, mLongpressAction, true);
            return true;
        }
    };
